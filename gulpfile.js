...
function jsPlugins(cb) {
	return gulp.src([
        ...
        pathTo.resolve('src', 'assets/js/slick/slick.min.js'),
        pathTo.resolve('src', 'assets/js/jscrollpane/jquery.mousewheel.js'),
        pathTo.resolve('src', 'assets/js/jscrollpane/jquery.jscrollpane.min.js'),
        pathTo.resolve('src', 'assets/js/cart.js')
	])
    .pipe(plumber({
		errorHandler: notify.onError("Error: <%= error.message %>")
	}))
